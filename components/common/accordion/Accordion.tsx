...
export function Accordion(props: AccordionProps) {
  ...
  return (
    ...
    >
      ...
      <label
        htmlFor={title}
        className={"flex flex-grow w-full gap-x-4 items-center transition-colors justify-center font-semibold bg-background-5 p-2 cursor-pointer hover:bg-background-5 peer-checked:bg-background-0"}
      >
        {title}
      </label>
      <FaChevronRight
