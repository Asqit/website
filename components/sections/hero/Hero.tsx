...
export function Hero() {
  return (
    <section className={'w-full min-h-screen text-gray-200'}>
      ...
      <div
        className={
          'w-full h-full backdrop-blur-3xl grid grid-cols-8 items-center justify-center'
        }
      >
        <article
        ...
        >
          ...
          <h1
            className={
              'text-3xl font-black md:text-6xl text-slate-100 animate-fade-in-up'
            }
          >
            Ondřej Tuček.
          </h1>
          <h2
            className={
              'text-3xl md:text-6xl font-black text-slate-400 animate-fade-in-up'
            }
          >
            I make web apps.
          </h2>
